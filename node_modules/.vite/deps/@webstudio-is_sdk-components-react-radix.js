...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/collapsible.js
var h = Root;
var g = (0, import_react.forwardRef)(({ children: e, ...o }, t2) => {
  const n3 = import_react.Children.toArray(e)[0];
...
function __rest(s3, e) {
  var t2 = {};
  for (var p3 in s3) if (Object.prototype.hasOwnProperty.call(s3, p3) && e.indexOf(p3) < 0)
    t2[p3] = s3[p3];
  if (s3 != null && typeof Object.getOwnPropertySymbols === "function")
    for (var i4 = 0, p3 = Object.getOwnPropertySymbols(s3); i4 < p3.length; i4++) {
      if (e.indexOf(p3[i4]) < 0 && Object.prototype.propertyIsEnumerable.call(s3, p3[i4]))
        t2[p3[i4]] = s3[p3[i4]];
    }
  return t2;
}
...
var RemoveScroll = React35.forwardRef(function(props, parentRef) {
  ...
  return React35.createElement(
    React35.Fragment,
    null,
    enabled && React35.createElement(SideCar4, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var O = (0, import_react5.forwardRef)((t2, e) => {
  const { renderer: o } = (0, import_react5.useContext)(ReactSdkContext), [n3, s3] = useControllableState({
    ...
    async (l2) => {
      await interactionResponse(), s3(l2);
    },
    [s3]
  );
  return (0, import_react5.useEffect)(() => {
    ...
    return window.addEventListener("click", l2), () => window.removeEventListener("click", l2);
...
var x = (0, import_react5.forwardRef)(({ children: t2, ...e }, o) => {
  const n3 = import_react5.Children.toArray(t2)[0];
  return (0, import_jsx_runtime13.jsx)(Trigger2, { ref: o, asChild: true, ...e, children: n3 ?? (0, import_jsx_runtime13.jsx)("button", { children: "Add button or link" }) });
});
...
var R = (0, import_react5.forwardRef)((t2, e) => {
  ...
  return (0, import_react5.useEffect)(() => {
    ...
    const s3 = (r4) => {
      const { target: l2 } = r4;
      if (C(r4) !== false) {
        if (!(l2 instanceof HTMLAnchorElement))
          return false;
        l2.closest('[role="dialog"]') && (o.current = true);
      }
    };
...
var $ = Close;
var A = "h1";
var N = (0, import_react5.forwardRef)(({ tag: t2 = A, children: e, ...o }, n3) => (0, import_jsx_runtime13.jsx)(DialogTitle, { asChild: true, children: (0, import_jsx_runtime13.jsx)(t2, { ref: n3, ...o, children: e }) }));
var S = Description;
  ...
  return {
    ...
    async fn(state) {
      ...
      if (!overflows.every((side2) => side2 <= 0)) {
        ...
        let resetPlacement = (_overflowsData$filter = overflowsData.filter((d4) => d4.overflows[0] <= 0).sort((a4, b) => a4.overflows[1] - b.overflows[1])[0]) == null ? void 0 : _overflowsData$filter.placement;
        if (!resetPlacement) {
          switch (fallbackStrategy) {
            case "bestFit": {
              ...
              const placement2 = (_overflowsData$filter2 = overflowsData.filter((d4) => {
                ...
                return true;
              }).map((d4) => [d4.placement, d4.overflows.filter((overflow2) => overflow2 > 0).reduce((acc, overflow2) => acc + overflow2, 0)]).sort((a4, b) => a4[1] - b[1])[0]) == null ? void 0 : _overflowsData$filter2[0];
              if (placement2) {
...
function getScale(element) {
  ...
  let x3 = ($5 ? round(rect.width) : rect.width) / width;
...
function deepEqual(a4, b) {
  ...
  if (typeof a4 === "function" && a4.toString() === b.toString()) {
    return true;
  }
  let length;
  let i4;
  let keys;
  if (a4 && b && typeof a4 === "object") {
    if (Array.isArray(a4)) {
      length = a4.length;
      if (length !== b.length) return false;
      for (i4 = length; i4-- !== 0; ) {
        if (!deepEqual(a4[i4], b[i4])) {
          return false;
        }
      }
      return true;
...
var RemoveScroll2 = React67.forwardRef(function(props, parentRef) {
  ...
  return React67.createElement(
    React67.Fragment,
    null,
    enabled && React67.createElement(SideCar4, { sideCar: effectCar2, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var deltaCompare2 = function(x3, y4) {
  return x3[0] === y4[0] && x3[1] === y4[1];
};
...
function RemoveScrollSideCar2(props) {
  ...
  return React70.createElement(
    ...
    removeScrollBar ? React70.createElement(RemoveScrollBar2, { noRelative: props.noRelative, gapMode: props.gapMode }) : null
  );
}
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/popover.js
var v2 = (0, import_react10.forwardRef)((o, t2) => (0, import_jsx_runtime23.jsx)(Root23, { ...o }));
var d = (0, import_react10.forwardRef)(({ children: o, ...t2 }, e) => {
  const r4 = import_react10.Children.toArray(o)[0];
  return (0, import_jsx_runtime23.jsx)(Trigger3, { asChild: true, ref: e, ...t2, children: r4 ?? (0, import_jsx_runtime23.jsx)("button", { children: "Add button or link" }) });
});
var h3 = (0, import_react10.forwardRef)(
  ({ sideOffset: o = 4, align: t2 = "center", hideWhenDetached: e = true, ...r4 }, a4) => (0, import_jsx_runtime23.jsx)(Portal3, { children: (0, import_jsx_runtime23.jsx)(
    Content22,
    {
      ref: a4,
      align: "center",
...
function useFloating2(options) {
  ...
  const floatingStyles = React82.useMemo(() => {
    ...
    const x3 = roundByDPR2(elements.floating, data.x);
...
function getHull(points) {
  ...
  newPoints.sort((a4, b) => {
    if (a4.x < b.x) return -1;
    else if (a4.x > b.x) return 1;
    else if (a4.y < b.y) return -1;
    else if (a4.y > b.y) return 1;
    else return 0;
  });
...
var h4 = (0, import_react12.forwardRef)(({ children: t2, ...o }, n3) => {
  const i4 = import_react12.Children.toArray(t2)[0];
  return (0, import_jsx_runtime33.jsx)(Trigger4, { asChild: true, ref: n3, ...o, children: i4 ?? (0, import_jsx_runtime33.jsx)("button", { children: "Add button or link" }) });
});
var T = (0, import_react12.forwardRef)(({ sideOffset: t2 = 4, hideWhenDetached: o = true, ...n3 }, i4) => (0, import_jsx_runtime33.jsx)(Portal5, { children: (0, import_jsx_runtime33.jsx)(
  Content23,
  {
    ref: i4,
    hideWhenDetached: o,
  ...
  function useCollection6(scope) {
    ...
    const getItems = import_react13.default.useCallback(() => {
      ...
      const orderedItems = items.sort(
        (a4, b) => orderedNodes.indexOf(a4.ref.current) - orderedNodes.indexOf(b.ref.current)
      );
      return orderedItems;
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/tabs.js
var k2 = (0, import_react15.forwardRef)(({ defaultValue: e, ...n3 }, o) => {
  const [t2, a4] = useControllableState({
    prop: n3.value,
    defaultProp: e ?? "",
    onChange: n3.onValueChange
  }), s3 = (0, import_react15.useCallback)(
    async (m7) => {
      await interactionResponse(), a4(m7);
    },
    [a4]
  );
...
var w = List;
var y = (0, import_react15.forwardRef)(({ value: e, ...n3 }, o) => {
  const t2 = getIndexWithinAncestorFromProps(n3);
  return (0, import_jsx_runtime43.jsx)(Trigger5, { ref: o, value: e ?? t2 ?? "", ...n3 });
});
var A2 = (0, import_react15.forwardRef)(({ value: e, ...n3 }, o) => {
  const t2 = getIndexWithinAncestorFromProps(n3);
  return (0, import_jsx_runtime43.jsx)(Content5, { ref: o, value: e ?? t2 ?? "", ...n3 });
});
...
var k3 = (0, import_react20.forwardRef)(({ value: t2, ...o }, e) => {
  const n3 = getIndexWithinAncestorFromProps(o);
  return (0, import_jsx_runtime56.jsx)(Item2, { ref: e, value: t2 ?? n3 ?? "", ...o });
});
var v3 = Header;
var w2 = Trigger22;
var y2 = Content24;
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/navigation-menu.js
var C3 = (0, import_react23.forwardRef)(({ value: o, ...n3 }, e) => {
  const { renderer: t2 } = (0, import_react23.useContext)(ReactSdkContext);
  let i4 = o;
  return t2 === "canvas" && (i4 = i4 === "" ? "-1" : i4), (0, import_jsx_runtime67.jsx)(Root27, { ref: e, value: i4, ...n3 });
});
var P2 = List2;
var k4 = Viewport;
var x2 = Content6;
...
var $3 = (0, import_react23.forwardRef)(({ children: o, ...n3 }, e) => {
  const t2 = import_react23.Children.toArray(o)[0];
...
function useFloating3(options) {
  ...
  const floatingStyles = React153.useMemo(() => {
    ...
    const x3 = roundByDPR3(elements.floating, data.x);
...
var RemoveScroll3 = React164.forwardRef(function(props, parentRef) {
  ...
  return React164.createElement(
    React164.Fragment,
    null,
    enabled && React164.createElement(SideCar4, { sideCar: effectCar3, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
var deltaCompare3 = function(x3, y4) {
  return x3[0] === y4[0] && x3[1] === y4[1];
};
...
function RemoveScrollSideCar3(props) {
  ...
  return React167.createElement(
    ...
    removeScrollBar ? React167.createElement(RemoveScrollBar3, { noRelative: props.noRelative, gapMode: props.gapMode }) : null
  );
}
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/select.js
var v5 = (0, import_react30.forwardRef)(({ value: e, defaultValue: t2, ...o }, n3) => (0, import_jsx_runtime81.jsx)(Root29, { ...o, defaultValue: e ?? t2 }));
var T2 = (0, import_react30.forwardRef)((e, t2) => {
  const { renderer: o } = (0, import_react30.useContext)(ReactSdkContext);
  return (0, import_jsx_runtime81.jsx)(Trigger7, { onPointerDown: o === "canvas" ? (a4) => {
    a4.preventDefault();
  } : void 0, ref: t2, ...e });
});
var $4 = (0, import_react30.forwardRef)((e, t2) => (0, import_jsx_runtime81.jsx)(Value, { ref: t2, ...e }));
var k5 = (0, import_react30.forwardRef)((e, t2) => (0, import_jsx_runtime81.jsx)(Portal7, { children: (0, import_jsx_runtime81.jsx)(Content25, { ref: t2, ...e, position: "popper" }) }));
var D2 = Viewport2;
var R2 = Item4;
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/switch.js
var d3 = (0, import_react31.forwardRef)(({ defaultChecked: e, ...o }, t2) => {
  const [r4, c7] = useControllableState({
    prop: o.checked ?? e ?? false,
    defaultProp: false
  });
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/checkbox.js
var p2 = (0, import_react32.forwardRef)(({ defaultChecked: e, ...o }, r4) => {
  const [t2, c7] = useControllableState({
    prop: o.checked ?? e ?? false,
    defaultProp: false
  });
  return (0, import_jsx_runtime91.jsx)(
    Checkbox,
    {
      ...
      ref: r4,
      checked: t2,
      onCheckedChange: (n3) => c7(n3 === true)
    }
  );
});
var s2 = CheckboxIndicator;
...
// node_modules/@webstudio-is/sdk-components-react-radix/lib/radio-group.js
var R3 = (0, import_react35.forwardRef)(({ defaultValue: r4, ...o }, t2) => {
  const [a4, e] = useControllableState({
    prop: o.value ?? r4 ?? "",
    defaultProp: ""
  });
  return (0, import_jsx_runtime102.jsx)(Root210, { ...o, value: a4, onValueChange: e, ref: t2 });
});
var I2 = Item22;
var G = Indicator;
export {
