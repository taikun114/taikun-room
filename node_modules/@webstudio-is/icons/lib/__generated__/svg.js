...
var ArrowUpIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 12.667V3.333M3.333 8 8 3.333 12.667 8"/></svg>`;
var AspectRatioIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5 4v7.667h7.667"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m3 5 2-2 2 2M11.667 9.667l2 2-2 2"/></svg>`;
var AsteriskIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 3.96v8.08M11.498 5.98l-6.996 4.04M4.502 5.98l6.996 4.04"/></svg>`;
var AttachmentIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8.823 13.501 14 8.2M10.667 4l-5.61 5.724a1.333 1.333 0 0 0 1.886 1.885l5.61-5.724a2.667 2.667 0 0 0-3.772-3.77l-5.61 5.723a4 4 0 0 0 2.83 6.829 3.922 3.922 0 0 0 2.804-1.147"/></svg>`;
var AutoScrollIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m5.502 10.5 2.5-5 2.5 5M6.126 9.25h3.75M2 14V2M14.003 14V2"/></svg>`;
...
var BorderRadiusBottomRightIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13 3v6.364A3.636 3.636 0 0 1 9.364 13H3"/></svg>`;
var BorderRadiusIndividualIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M2 4.667V3.333A1.333 1.333 0 0 1 3.333 2h1.334M11.333 2h1.334A1.333 1.333 0 0 1 14 3.333v1.334M14 11.333v1.334A1.333 1.333 0 0 1 12.667 14h-1.334M4.667 14H3.333A1.334 1.334 0 0 1 2 12.667v-1.334"/></svg>`;
var BorderRadiusTopLeftIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13 3H6.636A3.636 3.636 0 0 0 3 6.636V13"/></svg>`;
var BorderRadiusTopRightIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M3 3h6.364A3.636 3.636 0 0 1 13 6.636V13"/></svg>`;
var BorderRadiusIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="#11181C" fill-rule="evenodd" d="M1.917 10.666a8.75 8.75 0 0 1 8.75-8.75h2.666a.75.75 0 0 1 0 1.5h-2.667a7.25 7.25 0 0 0-7.25 7.25v2.667a.75.75 0 0 1-1.5 0v-2.667Z" clip-rule="evenodd"/></svg>`;
var BorderWidthBottomIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14 14H2m0-3.667v-7C2 2.597 2.597 2 3.333 2h9.334C13.403 2 14 2.597 14 3.333v7"/></svg>`;
var BorderWidthIndividualIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" d="M5.4 1.744h5.2M14.5 10.356v-5.2M1.5 10.356v-5.2M5.4 14.256h5.2"/></svg>`;
var BorderWidthLeftIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M2 14V2m3.667 0h7C13.403 2 14 2.597 14 3.333v9.334c0 .736-.597 1.333-1.333 1.333h-7"/></svg>`;
var BorderWidthRightIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14 2v12m-3.667 0h-7A1.333 1.333 0 0 1 2 12.667V3.333C2 2.597 2.597 2 3.333 2h7"/></svg>`;
var BorderWidthTopIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M2 2h12m0 3.667v7c0 .736-.597 1.333-1.333 1.333H3.333A1.333 1.333 0 0 1 2 12.667v-7"/></svg>`;
...
var CheckCircleIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><rect width="12" height="12" x="2" y="2" stroke="currentColor" rx="6"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.998 7.928 7.381 9.31 10 6.69"/></svg>`;
var CheckMarkSmallIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.998 7.928 7.381 9.31 10 6.69"/></svg>`;
...
var ChevronDownIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m4 6 4 4 4-4"/></svg>`;
var ChevronLeftIcon = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" width="100%" height="100%" style="display: block;"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3" d="m9.256 4.499-3.512 3.5 3.512 3.502"/></svg>`;
var ChevronRightIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m6 12 4-4-4-4"/></svg>`;
...
var ChevronsLeftIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" d="M7.069 12.656 2.413 8l4.656-4.656M13.587 12.656 8.931 8l4.656-4.656"/></svg>`;
var CloudIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M11.667 12.667H6a4.667 4.667 0 1 1 4.473-6h1.194a3 3 0 1 1 0 6Z"/></svg>`;
...
var CommitIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4ZM2 8h4M10 8h4"/></svg>`;
...
var CopyIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M13.214 5.5H6.786c-.71 0-1.286.576-1.286 1.286v6.428c0 .71.576 1.286 1.286 1.286h6.428c.71 0 1.286-.576 1.286-1.286V6.786c0-.71-.576-1.286-1.286-1.286Z"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M2.786 10.5A1.29 1.29 0 0 1 1.5 9.214V2.786A1.29 1.29 0 0 1 2.786 1.5h6.428A1.29 1.29 0 0 1 10.5 2.786"/></svg>`;
var CropIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.167 1.5v9.333A1.333 1.333 0 0 0 5.5 12.167h9.333m-2.666 2.666V5.5a1.333 1.333 0 0 0-1.334-1.333H1.5"/></svg>`;
var DashedBorderIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M3.714 8H2M8.857 8H7.143M14 8h-1.714"/></svg>`;
var DescriptionIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.333 3.135a.47.47 0 0 0-.802-.332L4.275 5.058a.933.933 0 0 1-.664.275H2A.667.667 0 0 0 1.333 6v4a.667.667 0 0 0 .667.667h1.61a.934.934 0 0 1 .665.275l2.256 2.256a.47.47 0 0 0 .802-.333v-9.73ZM10.667 6a3.333 3.333 0 0 1 0 4M12.91 12.243a6 6 0 0 0 0-8.486"/></svg>`;
...
var LargeXIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.5 3 3 12.5M3 3l9.5 9.5"/></svg>`;
var LifeBuoyIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><circle cx="7.995" cy="7.995" r="6.665" stroke="#000"/><path d="m3.287 3.287 2.826 2.826M9.886 6.113l2.827-2.826M9.886 9.887l2.827 2.826M6.113 9.887l-2.827 2.826"/><circle cx="7.995" cy="7.995" r="2.665" stroke="#000"/></svg>`;
...
var MicOffIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m1.333 1.333 13 13M12.593 8.82c.048-.27.073-.545.074-.82V6.667M3.333 6.667V8a4.667 4.667 0 0 0 8 3.333M10 6.227V3.333a2 2 0 0 0-3.787-.886"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M6 6v2a2 2 0 0 0 3.413 1.413M8 12.667v2"/></svg>`;
var MicIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 1.333a2 2 0 0 0-2 2V8a2 2 0 1 0 4 0V3.333a2 2 0 0 0-2-2Z"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.667 6.667V8a4.666 4.666 0 1 1-9.334 0V6.667M8 12.667v2"/></svg>`;
var MinimizeIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M2.667 9.333h4v4M13.333 6.667h-4v-4M9.333 6.667 14 2M2 14l4.667-4.667"/></svg>`;
...
var RadioUncheckedIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 14.5a6.5 6.5 0 1 0 0-13 6.5 6.5 0 0 0 0 13Z"/></svg>`;
...
var SearchIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.333 12.667A5.333 5.333 0 1 0 7.333 2a5.333 5.333 0 0 0 0 10.667ZM14 14l-2.867-2.867"/></svg>`;
var SectionLinkIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M2.667 14.667H12a1.333 1.333 0 0 0 1.333-1.334V4.667L10 1.333H4a1.333 1.333 0 0 0-1.333 1.334v2.666"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.333 1.333V4a1.333 1.333 0 0 0 1.334 1.333h2.666M2 10h4"/></svg>`;
...
var TerminalIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4.667 7.333 6 6 4.667 4.667M7.333 8.667H10"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.667 2H3.333C2.597 2 2 2.597 2 3.333v9.334C2 13.403 2.597 14 3.333 14h9.334c.736 0 1.333-.597 1.333-1.333V3.333C14 2.597 13.403 2 12.667 2Z"/></svg>`;
var TextAlignCenterIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="currentColor" fill-rule="evenodd" d="M2 3.5a.5.5 0 0 0 0 1h12a.5.5 0 0 0 0-1H2ZM4.167 8a.5.5 0 0 1 .5-.5h6.666a.5.5 0 0 1 0 1H4.667a.5.5 0 0 1-.5-.5Zm-1.334 4a.5.5 0 0 1 .5-.5h9.334a.5.5 0 0 1 0 1H3.333a.5.5 0 0 1-.5-.5Z" clip-rule="evenodd"/></svg>`;
...
var TextStrikethroughIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M10.667 2.667H6a2 2 0 0 0-1.887 2.666M9.333 8a2.667 2.667 0 1 1 0 5.333H4M2.667 8h10.666"/></svg>`;
var TextTruncateIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14 11V3.333A1.334 1.334 0 0 0 12.667 2H3.333A1.333 1.333 0 0 0 2 3.333v9.334A1.333 1.333 0 0 0 3.333 14H5.5"/><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 13.375a.375.375 0 1 0 .75 0 .375.375 0 0 0-.75 0ZM10.813 13.375a.375.375 0 1 0 .75 0 .375.375 0 0 0-.75 0ZM13.625 13.375a.375.375 0 1 0 .75 0 .375.375 0 0 0-.75 0Z"/></svg>`;
var TextUnderlineIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M4 2.667v4a4 4 0 0 0 8 0v-4M2.667 13.333h10.666"/></svg>`;
var TextUppercaseIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M1.5 10.811 4.31 5.19l2.812 5.622M2.202 9.406h4.217M9.933 8h3.162a1.406 1.406 0 1 1 0 2.811H9.933V5.19h2.81a1.406 1.406 0 1 1 0 2.811"/></svg>`;
...
var WrapIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M3.49 2.237h-.98c-.542 0-.982.403-.982.9V6.07c0 .497.44.9.981.9h.982c.542 0 .981-.403.981-.9V3.137c0-.497-.44-.9-.981-.9ZM3.49 9.03h-.98c-.542 0-.982.403-.982.9v2.933c0 .497.44.9.981.9h.982c.542 0 .981-.403.981-.9V9.93c0-.497-.44-.9-.981-.9ZM8.49 2.237h-.98c-.542 0-.982.403-.982.9V6.07c0 .497.44.9.981.9h.982c.542 0 .981-.403.981-.9V3.137c0-.497-.44-.9-.981-.9ZM7 11.397H13.641a.862.862 0 0 0 .862-.862v0-5.173 0a.862.862 0 0 0-.862-.862H12m-5 6.897 2-2m-2 2 2 2"/></svg>`;
var XAxisRotateIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 17" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M9.473 12.528c-.579 1.944-1.563 3.222-2.681 3.222-1.78 0-3.223-3.246-3.223-7.25s1.442-7.25 3.223-7.25c1.78 0 3.222 3.246 3.222 7.25"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M7.597 6.083 10.014 8.5l2.417-2.417"/></svg>`;
var XAxisIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.636 2.68v8.275h8.275M2.09 14.502l3.546-3.547"/><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="m12.134 8.591 2.364 2.364-2.364 2.365"/></svg>`;
var XCircledFilledIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="currentColor" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M8 14.5a6.5 6.5 0 1 0 0-13 6.5 6.5 0 0 0 0 13Z"/><path stroke="#fff" stroke-linecap="round" stroke-linejoin="round" d="m5.333 10.667 5.334-5.334M10.667 10.667 5.333 5.333"/></svg>`;
var XLogoIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="#000" d="M9.142 7.081 13.609 2H12.55L8.671 6.412 5.573 2H2l4.685 6.672L2 14h1.059l4.096-4.66L10.427 14H14L9.141 7.081Zm-1.45 1.65-.475-.665L3.44 2.78h1.626l3.048 4.266.475.664 3.962 5.546h-1.626L7.692 8.73Z"/></svg>`;
var XSmallIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="#000" stroke-linecap="round" stroke-linejoin="round" d="m5.333 10.667 5.334-5.334M10.667 10.667 5.333 5.333"/></svg>`;
var XIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M12.5 3 3 12.5M3 3l9.5 9.5"/></svg>`;
...
var ZAxisRotateIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 17" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M14 9.28a5.993 5.993 0 0 1-2.007 3.736 6.04 6.04 0 0 1-7.962-.024 5.98 5.98 0 0 1-.988-7.867A6.025 6.025 0 0 1 6.526 2.69a6.049 6.049 0 0 1 4.23.462 6.01 6.01 0 0 1 2.868 3.129M14 2.53v3.75h-3.766"/></svg>`;
var ZAxisIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.636 2.09v8.274h8.275M2.09 13.91l3.546-3.546m-3.547 3.547h3.547m-3.547 0v-3.744"/></svg>`;
export {
  AccordionIcon,
